...
| `TC-FEEDS-002` | E2E  | `tests/e2e/feeds-management.spec.ts`    | Shared burger menu reaches the feed page from its first entry.     | Opening the burger menu shows feed management as the first entry and selecting it routes to `/feeds`.                                               |
