...
- End-to-end scenarios: `docs/test-scenarios.md`
...
- `TIMELINE-003`: The timeline shall fetch folders, feeds, and unread items from the Nextcloud News v1.3 backend and reconcile them into a client-side folder queue.
