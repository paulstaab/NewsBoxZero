...
function LoginContent() {
  ...
  const handleServerUrlSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
    e.preventDefault();
  ...
  const handleCredentialsSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
    e.preventDefault();
    setValidationError(null);
  ...
  const handlePlainSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
    e.preventDefault();
    setValidationError(null);
