 ...
 * 
 * Step 1: Server URL validation with HTTPS enforcement
...
export default function LoginPage() {
  ...
  const handleServerUrlSubmit = (e: FormEvent) => {
    e.preventDefault();
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="mb-8 flex justify-center space-x-2">
            <div className={`h-2 w-16 rounded-full ${step >= LoginStep.SERVER_URL ? 'bg-blue-600' : 'bg-gray-300'}`} />
            <div className={`h-2 w-16 rounded-full ${step >= LoginStep.CREDENTIALS ? 'bg-blue-600' : 'bg-gray-300'}`} />
            <div className={`h-2 w-16 rounded-full ${step >= LoginStep.AUTHENTICATING ? 'bg-blue-600' : 'bg-gray-300'}`} />
          </div>
          ...
          {step === LoginStep.SERVER_URL && (
            <form onSubmit={handleServerUrlSubmit} className="space-y-6">
              <div>
          ...
          {step === LoginStep.CREDENTIALS && (
            <form onSubmit={(e) => { void handleCredentialsSubmit(e); }} className="space-y-6">
              <div>
