...
export interface VersionApi {
   ...
   */
  get(baseUrl: string): Promise<VersionResponse>;
}
...
class ApiClientImpl implements ApiClient {
  ...
  constructor() {
    ...
    this.auth = {
      validateCredentials: async (baseUrl: string, authCredentials: string) => {
        return baseValidateCredentials(baseUrl, authCredentials);
      },
    };
  }
}
